...
func InterpolateStrings(configValues map[string]string, content string) (string, error) {
	//stanza vars override envars values
	stanzaVars := helper.MapKeys[string, string](configValues, strings.ToLower)
